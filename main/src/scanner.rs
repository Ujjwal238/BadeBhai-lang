...
impl Scanner {
    ...
    fn keyword(check: &str) -> Option<TokenType> {
        match check {
            ...
            "aur" => Some(TokenType::And),
            "class" => Some(TokenType::Class),
            "else" => Some(TokenType::Else),
            "galat" => Some(TokenType::False),
            "for" => Some(TokenType::For),
            "fun" => Some(TokenType::Fun),
            "if" => Some(TokenType::If),
            "nil" => Some(TokenType::Nil),
            "ya" => Some(TokenType::Or),
            "dikaho" => Some(TokenType::Print),
            "return" => Some(TokenType::Return),
            "super" => Some(TokenType::Super),
            "this" => Some(TokenType::This),
            "sahi" => Some(TokenType::True),
            "yehai" => Some(TokenType::Var),
            "jabtak" => Some(TokenType::While),
            "ruko" => Some(TokenType::Break),
